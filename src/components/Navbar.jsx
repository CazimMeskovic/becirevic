...
import { HiOutlineMenuAlt4 } from 'react-icons/hi';
import { HiOutlineMail } from 'react-icons/hi';
import { FaFacebook, FaTwitter, FaInstagram, FaPinterest, FaYoutube, FaBars, FaTimes, FaGithub, FaLinkedin, FaLinkedinIn } from 'react-icons/fa';
import { Link } from 'react-scroll';
...
const Navbar = () => {
  ...
  return (
    <div name='navbar' className='absolute flex w-full cursor-pointer from-sky-600 justify-between items-center h-20 px-4 z-10 text-white'>
      <div>
        <h1 onClick={handleNav} className={logo ? 'hidden' : 'block'}>
          <span className='text-teal-200 hover:text-teal-400'>Apartman's Becirevic</span>
        </h1>
      </div>
      <ul className='hidden md:flex'>
        <li>
          <Link className='hover:text-teal-200' to='hero' smooth={true} duration={500}>
            Home
          </Link>
        </li>
        <li>
          <Link className='hover:text-teal-200' to='destination' smooth={true} duration={500}>
            Destinations
          </Link>
        </li>
        <li>
          <Link className='hover:text-teal-200' to='search' smooth={true} duration={500}>
            Travel
          </Link>
        </li>
        <li>
          <Link className='hover:text-teal-200' to='carousel' smooth={true} duration={500}>
            View
          </Link>
        </li>
        <li>
          <Link className='hover:text-teal-200' to='contact' smooth={true} duration={500}>
            Contact
          </Link>
        </li>
      </ul>
